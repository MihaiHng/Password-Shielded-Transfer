// // src/components/CreateTransfers.tsx
...
// // --- MOVED getPSTContractAddress HERE ---
...
//             // Invalidate queries for PendingTransfers to force a refetch
//             // This will ensure the new transfer appears automatically.
//             queryClient.invalidateQueries({
//                 queryKey: ['readContract', {
//                     address: pstContractAddress,
//                     abi: PST_CONTRACT_ABI,
//                     // Invalidate both getPendingTransfers (for "all" view)
//                     // and getPendingTransfersForAddress (for "sent" view)
//                     functionName: ['getPendingTransfers', 'getPendingTransfersForAddress']
//                 }],
//                 // You can also refine by exact query args if needed,
//                 // but invalidating by functionName is usually sufficient here.
//             });

//             // Toggle this state AFTER invalidation, it's a secondary trigger for the child,
//             // but query invalidation is the primary mechanism.
//             setRefetchPendingTransfers(prev => !prev);
//         }
//     }, [isConfirmed, queryClient, pstContractAddress]);
...
const CreateTransfer: React.FC = () => {
    ...
    //         // Removed: Toggle this state AFTER invalidation, it's a secondary trigger for the child,
    //         // but query invalidation is the primary mechanism.
    //         // setRefetchPendingTransfers(prev => !prev);
    //     }
    // }, [isConfirmed, queryClient, pstContractAddress, PST_CONTRACT_ABI, chain?.id]); // Added necessary dependencies for queryKey
