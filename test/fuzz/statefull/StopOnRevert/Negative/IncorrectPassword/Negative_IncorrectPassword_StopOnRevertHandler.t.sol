...
contract Negative_IncorrectPassword_StopOnRevertHandler is Test {
    PST public pst;
    ...
    function claimWithIncorrectPassword(uint256 index) public {
        console.log("Handler: claimWithIncorrectPassword called");
        ...
        string memory incorrectPassword = "notgood";

        vm.startPrank(receiver);
        pst.claimTransfer(transferId, incorrectPassword);
        vm.stopPrank();
    }
